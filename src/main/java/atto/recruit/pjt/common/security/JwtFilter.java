...
//
//import static atto.recruit.pjt.common.error.ErrorCode.ACCESS_TOKEN_EXPIRED;
//
//import atto.recruit.pjt.common.error.ErrorResponse;
...
//            if (!path.startsWith("/szs/signup") || !path.startsWith("/szs/login")) {
